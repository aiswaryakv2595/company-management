...
import { adminApi, dutyApi, employeeApi, teamleadApi } from "../../../redux/api/employeeApi";
...
const EmployeeTimesheet = () => {
      ...
      if (name === "project_id") {
        ...
        if (selectedProject) {
          const fetchTasks = async () => {
            try {
              const response = await employeeApi.getEmployeeTask(selectedProject._id);
    ...
    const columns = [
        ...
        { field: "date", headerName: "Date", width: 200 },
        {
          ...
          width: 200,
          valueGetter: (params) =>
            params.row.project_id ? params.row.project_id.project_name : "",
        },
        {
          field: "task",
          headerName: "Task",
          ...
          valueGetter: (params) => {
            ...
            const project = params.row.project_id;
      
            if (project && project.task) {
              const matchingTask = project.task.find((task) => task._id === taskId);
